...
public class SocketClient extends Socket {
	...
	/**
	 * Construit un SocketClient à l'aide du constructeur de Socket, à partir d'une
	 * adresse IP donnée et d'un port donné
	 * 
	...
	/**
	 * Cette méthode permet de lire un objet reçu provenant d'un Socket et le
	 * retourne
	 * 
